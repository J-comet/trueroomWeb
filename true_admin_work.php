...
//기업 유저
$query = "SELECT * FROM member WHERE admin != '1' AND verify = '1'";    // 기업회원의 모든 데이터를 조회
$result = mysqli_query($connect,$query);
$total_user = mysqli_num_rows($result);
...
<ul class="nav nav-pills">
 ...
 <li class="nav-item">
   <a class="nav-link active" href="#">인증회원</a>
 </li>
...
<br><br>
  <table class="table table-bordered" style="text-align:center; margin-top:20px; margin:0; padding:0;">
    ...
    <tbody>
      ...
      $query1 ="SELECT * FROM member WHERE verify = '1' order by idx desc limit $start,$view_user"; // idx 를 기준으로 내림차순정렬
