...
<span style="margin-left:150px; font-size:20px;">일반 회원수 :&nbsp&nbsp <?php echo $total_user;?> 명 </span>

<!-- <span style="margin-left:150px; font-size:20px;">기업 회원수 :&nbsp&nbsp <?php echo $total_user - $total_basic_user;?> 명 </span> -->
...
<ul class="nav nav-pills">
 <li class="nav-item">
   <a class="nav-link" href="true_admin.php">모든회원</a>
 </li>
 <li class="nav-item">
...
<br><br>
  <table class="table table-bordered" style="text-align:center; margin-top:20px; margin:0; padding:0;">
    ...
    <tbody>
      ...
      $query1 ="SELECT * FROM member WHERE verify = '0' order by idx desc limit $start,$view_user"; // idx 를 기준으로 내림차순정렬
    ...
    <tr>
      <td style="vertical-align:middle">
        ...
        if ($verify == 0) {
          ...
          echo $useremail."<br>";
          echo "<font color='#00bf00'>[기업회원]</font>";
        }
         ?>
      </td>
